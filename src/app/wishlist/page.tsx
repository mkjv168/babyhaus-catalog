        ...
        {items.length === 0 ? (
          <div className="text-center py-20">
            <div className="max-w-md mx-auto">
              <div className="w-16 h-16 mx-auto mb-4 bg-[#f5f1ec] rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#7a7a7a]">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#d4a574] text-white font-semibold rounded-xl hover:bg-[#c19660] transition-colors"
              >
