...
export function CompactProductCard({ product }: CompactProductCardProps) {
  ...
  return (
    <Link
      ...
      className="group block bg-white rounded-2xl overflow-hidden border border-[#e8e4df] transition-all duration-200 active:scale-[0.98] hover:shadow-md hover:border-[#d4a574]/30"
    >
