...
function AccordionSection({ title, children }: { title: string; children: React.ReactNode }) {
  ...
  return (
    <div className="md:hidden border-b border-[#F0E6DD] last:border-0">
      <button
...
export function Footer() {
  return (
    <footer className="bg-white border-t border-[#F0E6DD]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
        ...
        <div className="mt-6 md:mt-10 pt-4 md:pt-6 border-t border-[#F0E6DD] flex items-center justify-center md:justify-between gap-3 text-xs text-[#6B6B6B]">
          <p>
